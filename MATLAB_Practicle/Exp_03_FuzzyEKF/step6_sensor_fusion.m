...
%
% Students will learn:
% - Why a single sensor is insufficient for reliable navigation
% - How to simulate multiple sensors with realistic noise models
% - How EKF fuses noisy measurements into a clean state estimate
% - The predict → update cycle of Bayesian filtering
%
% SENSORS SIMULATED:
...
plot(time_vec(1:end-1), imu_readings(1:N_final-1), 'r-', 'LineWidth', 1.0, 'Alpha', 0.7);
hold off;
