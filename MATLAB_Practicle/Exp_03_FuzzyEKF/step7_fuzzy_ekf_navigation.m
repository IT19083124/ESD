...
%
% Students will learn:
% - How EKF state estimates replace raw sensor readings as fuzzy inputs
% - How sensor uncertainty (covariance) can modulate fuzzy rule weights
% - How multi-sensor awareness makes the robot safer and more robust
%
% ARCHITECTURE:
%
%   ┌─────────────┐    ┌─────────────────────────────────────────┐
